...
const ProjectCard = ({ title, description, gitLink, livePreview, previewImage }) => {
  return (
    <View style={styles.cardContainer}>
      {title ? (
        ...
        <SkeletonPlaceholder>
          <SkeletonPlaceholder.Item height={30} width={150} marginBottom={10} borderRadius={5} />
        </SkeletonPlaceholder>
      )}
      {previewImage && (
      ...
      <View style={styles.cardBody}>
        {description ? (
          ...
          <SkeletonPlaceholder>
            <SkeletonPlaceholder.Item height={60} marginBottom={10} borderRadius={5} />
            <SkeletonPlaceholder.Item height={60} marginBottom={10} borderRadius={5} />
            <SkeletonPlaceholder.Item height={60} marginBottom={10} borderRadius={5} />
          </SkeletonPlaceholder>
        )}
